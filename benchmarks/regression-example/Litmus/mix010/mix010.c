 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix010.litmus
 *

X86 mix010
"Fre PodWR Fre PodWW Rfi PodRR Fre Rfi PodRR"
Cycle=Rfi PodRR Fre Rfi PodRR Fre PodWR Fre PodWW
Relax=[Rfi,PodRR] PodWR
Safe=Fre PodWW
{
}
 P0          | P1          | P2          ;
 MOV [a],$1  | MOV [x],$1  | MOV [z],$1  ;
 MOV EAX,[x] | MOV [y],$1  | MOV EAX,[z] ;
             | MOV EAX,[y] | MOV EBX,[a] ;
             | MOV EBX,[z] |             ;
exists
