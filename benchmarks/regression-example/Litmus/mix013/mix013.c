 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix013.litmus
 *

X86 mix013
"Fre PodWR Fre Rfi PodRR Fre PodWR Fre Rfi PodRR"
Cycle=Rfi PodRR Fre PodWR Fre Rfi PodRR Fre PodWR Fre
...
Safe=Fre
{
 ...
 MOV EAX,[x] | MOV EAX,[x] | MOV EAX,[z] | MOV EAX,[z] ;
             | MOV EBX,[y] |             | MOV EBX,[a] ;
exists
(0:EAX=0 /\ 1:EAX=1 /\ 1:EBX=0 /\ 2:EAX=0 /\ 3:EAX=1 /\ 3:EBX=0)
