 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix014.litmus
 *

X86 mix014
"Fre PodWW Wse Rfi PodRR Fre PodWR Fre Rfi PodRR"
Cycle=Rfi PodRR Fre PodWW Wse Rfi PodRR Fre PodWR Fre
...
Safe=Fre Wse PodWW
{
 ...
 MOV [x],$1 | MOV EAX,[x] | MOV EAX,[z] | MOV EAX,[z] ;
            | MOV EBX,[y] |             | MOV EBX,[a] ;
exists
(x=2 /\ 1:EAX=2 /\ 1:EBX=0 /\ 2:EAX=0 /\ 3:EAX=1 /\ 3:EBX=0)
...
int main(void) 
{
  ...
  //printf("x=%d, cond1=%d.cond2=%d, cond3=%d",x,cond1,cond2,cond3);
