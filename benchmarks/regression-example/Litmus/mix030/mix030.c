 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix030.litmus
 *

X86 mix030
"Fre PodWW Wse PodWW Wse PodWW Wse Rfi PodRR"
...
Safe=Fre Wse PodWW
{
 ...
 P0         | P1         | P2         | P3          ;
 MOV [a],$1 | MOV [x],$2 | MOV [y],$2 | MOV [z],$2  ;
 MOV [x],$1 | MOV [y],$1 | MOV [z],$1 | MOV EAX,[z] ;
            |            |            | MOV EBX,[a] ;
exists
(x=2 /\ y=2 /\ z=2 /\ 3:EAX=2 /\ 3:EBX=0)
