 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix015.litmus
 *

X86 mix015
"Fre PodWW Rfi PodRR Fre PodWR Fre Rfi PodRR"
Cycle=Rfi PodRR Fre PodWW Rfi PodRR Fre PodWR Fre
...
Safe=Fre PodWW
{
 ...
 MOV [x],$1  | MOV EAX,[z] | MOV EAX,[z] ;
 MOV EAX,[x] |             | MOV EBX,[a] ;
 MOV EBX,[y] |             |             ;
exists
(0:EAX=1 /\ 0:EBX=0 /\ 1:EAX=0 /\ 2:EAX=1 /\ 2:EBX=0)
