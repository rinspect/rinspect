 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix021.litmus
 *

X86 mix021
"Fre PodWW Wse PodWW Wse PodWR Fre Rfi PodRR"
Cycle=Rfi PodRR Fre PodWW Wse PodWW Wse PodWR Fre
...
Safe=Fre Wse PodWW
{
 ...
 MOV [x],$1 | MOV [y],$1 | MOV EAX,[z] | MOV EAX,[z] ;
            |            |             | MOV EBX,[a] ;
exists
