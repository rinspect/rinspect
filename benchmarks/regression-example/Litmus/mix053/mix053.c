 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix053.litmus
 *

X86 mix053
"Fre PodWW Wse PodWW Wse PodWR Fre PodWR"
Cycle=Fre PodWW Wse PodWW Wse PodWR Fre PodWR
Relax=PodWR
Safe=Fre Wse PodWW
{
}
 ...
 MOV [x],$1 | MOV [y],$1 | MOV EAX,[z] | MOV EAX,[a] ;
exists
(x=2 /\ y=2 /\ 2:EAX=0 /\ 3:EAX=0)
