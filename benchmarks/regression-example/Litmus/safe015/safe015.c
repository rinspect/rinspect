 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//safe015.litmus
 *

X86 safe015
"Wse MFencedWR Fre PosWW Rfe PodRW"
...
Safe=Rfe Fre Wse PosWW PodRW MFencedWR
{
 ...
 P0          | P1         | P2          ;
 MOV [y],$2  | MOV [x],$1 | MOV EAX,[x] ;
 MFENCE      | MOV [x],$2 | MOV [y],$1  ;
 MOV EAX,[x] |            |             ;
exists
(x=2 /\ y=2 /\ 0:EAX=0 /\ 2:EAX=2)
