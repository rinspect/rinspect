 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix006.litmus
 *

 X86 mix006
 "Fre PodWW Wse Rfi PodRR Fre Rfi PodRR"
 ...
 P0         | P1          | P2          ;
 MOV [z],$1 | MOV [x],$2  | MOV [y],$1  ;
 MOV [x],$1 | MOV EAX,[x] | MOV EAX,[y] ;
            | MOV EBX,[y] | MOV EBX,[z] ;
 exists
 (x=2 /\ 1:EAX=2 /\ 1:EBX=0 /\ 2:EAX=1 /\ 2:EBX=0)
