; ModuleID = '/home/naling/src/examples/tso/regression-examples/safe000/safe000.c.lz.opt.bc'
...
land.lhs.true6:                                   ; preds = %land.lhs.true
  %tmp8 = load i32* %cond1, align 4, !dbg !158, !clap !165
  %tobool7 = icmp ne i32 %tmp8, 0, !dbg !158, !clap !166
  br i1 %tobool7, label %land.lhs.true8, label %if.end, !dbg !158, !clap !167

land.lhs.true8:                                   ; preds = %land.lhs.true6
  %tmp9 = load i32* %cond2, align 4, !dbg !158, !clap !168
  %tobool9 = icmp ne i32 %tmp9, 0, !dbg !158, !clap !169
  br i1 %tobool9, label %if.then, label %if.end, !dbg !158, !clap !170

if.then:                                          ; preds = %land.lhs.true8
  %call10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([37 x i8]* @.str3, i32 0, i32 0)), !dbg !171, !clap !173
  %call11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([30 x i8]* @.str4, i32 0, i32 0)), !dbg !174, !clap !175
...
!0 = metadata !{i32 720913, i32 0, i32 12, metadata !"/home/naling/src/examples/tso/regression-examples/safe000/safe000.c", metadata !"/home/naling/src/inspect-0.3", metadata !"clang version 3.0 (tags/RELEASE_30/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !18} ; [ DW_TAG_compile_unit ]
...
!6 = metadata !{i32 720937, metadata !"/home/naling/src/examples/tso/regression-examples/safe000/safe000.c", metadata !"/home/naling/src/inspect-0.3", null} ; [ DW_TAG_file_type ]
...
!138 = metadata !{i32 66}
!139 = metadata !{i32 67}
!140 = metadata !{i32 64, i32 3, metadata !117, null}
!141 = metadata !{i32 68}
!142 = metadata !{i32 65, i32 3, metadata !117, null}
!143 = metadata !{i32 69}
!144 = metadata !{i32 66, i32 3, metadata !117, null}
!145 = metadata !{i32 70}
!146 = metadata !{i32 68, i32 3, metadata !117, null}
!147 = metadata !{i32 71}
!148 = metadata !{i32 72}
!149 = metadata !{i32 73}
!150 = metadata !{i32 69, i32 3, metadata !117, null}
!151 = metadata !{i32 74}
!152 = metadata !{i32 75}
!153 = metadata !{i32 76}
!154 = metadata !{i32 70, i32 3, metadata !117, null}
!155 = metadata !{i32 77}
!156 = metadata !{i32 78}
!157 = metadata !{i32 79}
!158 = metadata !{i32 73, i32 3, metadata !117, null}
!159 = metadata !{i32 80}
!160 = metadata !{i32 81}
!161 = metadata !{i32 82}
!162 = metadata !{i32 83}
...
!172 = metadata !{i32 720907, metadata !117, i32 73, i32 42, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!173 = metadata !{i32 92}
