	.file	"/home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c.lz.opt.bc"
	.file	1 "/home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c"
...
.Ltmp2:
	.cfi_startproc
.Lfunc_begin0:
	.loc	1 31 0                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:31:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp3:
...
.Ltmp5:
	...
	.loc	1 33 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:33:3
.Ltmp6:
	movl	$1, x
	movl	$8, 20(%esp)
	movl	$32, 16(%esp)
	...
	.loc	1 35 2                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:35:2
	lock
	addl	$0, x
	movl	$9, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 36 3                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:36:3
	movl	x, %esi
	movl	$10, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	movl	%esi, 32(%esp)
	cmpl	$1, %esi
	.loc	1 38 3                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:38:3
	sete	%al
	movzbl	%al, %eax
	addl	$40, %esp
	popl	%esi
...
.Ltmp12:
	.cfi_startproc
.Lfunc_begin1:
	.loc	1 43 0                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:43:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp13:
	.cfi_def_cfa_offset 8
...
.Ltmp15:
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 45 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:45:3
.Ltmp16:
	movl	$2, x
	movl	$24, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 46 3                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:46:3
	movl	$1, y
	movl	$25, 20(%esp)
	movl	$32, 16(%esp)
	movl	$0, 12(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 47 3                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:47:3
	movl	y, %esi
	movl	$26, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 48 3                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:48:3
	movl	x, %esi
	movl	$28, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	calll	clap_load_post
	movl	%esi, 28(%esp)
	.loc	1 49 3                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:49:3
	movl	32(%esp), %eax
	movl	%esi, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$.L.str, (%esp)
	calll	printf
	xorb	%al, %al
	.loc	1 50 3                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:50:3
	cmpl	$1, 32(%esp)
	jne	.LBB1_2
# BB#1:                                 # %land.rhs
	cmpl	$0, 28(%esp)
...
.LBB1_2:                                # %land.end
	movzbl	%al, %eax
	.loc	1 51 1                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:51:1
	addl	$40, %esp
	popl	%esi
	ret
.Ltmp18:
...
.Ltmp23:
	.cfi_startproc
.Lfunc_begin2:
	.loc	1 57 0                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:57:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp24:
	.cfi_def_cfa_offset 8
...
.Ltmp26:
	...
	movl	$0, 52(%esp)
	leal	48(%esp), %eax
	.loc	1 61 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:61:3
.Ltmp27:
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P0, 8(%esp)
	...
	leal	44(%esp), %eax
	.loc	1 62 3                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:62:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P1, 8(%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_create
	.loc	1 64 3                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:64:3
	movl	48(%esp), %eax
	leal	32(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 65 3                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:65:3
	movl	44(%esp), %eax
	leal	28(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 68 3                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:68:3
	cmpl	$0, 32(%esp)
	je	.LBB2_4
# BB#1:                                 # %land.lhs.true
	cmpl	$0, 28(%esp)
...
# BB#2:                                 # %land.lhs.true5
	...
	jne	.LBB2_4
# BB#3:                                 # %if.then
	.loc	1 69 5                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:69:5
.Ltmp28:
	movl	$.L.str1, (%esp)
	calll	printf
	.loc	1 70 5                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:70:5
	movl	$.L.str2, (%esp)
	calll	printf
.Ltmp29:
.LBB2_4:                                # %if.end
	xorl	%eax, %eax
	.loc	1 73 3                  # /home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c:73:3
	addl	$56, %esp
	popl	%esi
	ret
.Ltmp30:
...
.Linfo_begin1:
	...
	.ascii	 "/home/naling/src/examples/tso/regression-examples/rfi002/rfi002.c" # DW_AT_name
	.byte	0
