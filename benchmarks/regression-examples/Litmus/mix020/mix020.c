 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix020.litmus
 *

X86 mix020
"Fre PodWR Fre PodWW Wse PodWR Fre Rfi PodRR"
Cycle=Rfi PodRR Fre PodWR Fre PodWW Wse PodWR Fre
Relax=[Rfi,PodRR] PodWR
Safe=Fre Wse PodWW
{
}
 P0          | P1         | P2          | P3          ;
 MOV [a],$1  | MOV [x],$1 | MOV [y],$2  | MOV [z],$1  ;
 MOV EAX,[x] | MOV [y],$1 | MOV EAX,[z] | MOV EAX,[z] ;
             |            |             | MOV EBX,[a] ;
exists
