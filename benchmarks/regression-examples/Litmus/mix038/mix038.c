 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix038.litmus
 *

X86 mix038
"Fre PodWW Wse PodWR Fre PodWW Rfi PodRR"
Cycle=Rfi PodRR Fre PodWW Wse PodWR Fre PodWW
Relax=[Rfi,PodRR] PodWR
Safe=Fre Wse PodWW
{
}
 P0         | P1          | P2          ;
 MOV [a],$1 | MOV [x],$2  | MOV [y],$1  ;
 MOV [x],$1 | MOV EAX,[y] | MOV [z],$1  ;
            |             | MOV EAX,[z] ;
            |             | MOV EBX,[a] ;
exists
(x=2 /\ 1:EAX=0 /\ 2:EAX=1 /\ 2:EBX=0)
