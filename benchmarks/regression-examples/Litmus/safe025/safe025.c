 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//safe025.litmus
 *

X86 safe025
"Fre MFencedWR Fre PosWW Rfe PodRR"
...
Safe=Rfe Fre PosWW PodRR MFencedWR
{
 ...
 P0          | P1         | P2          ;
 MOV [y],$1  | MOV [x],$1 | MOV EAX,[x] ;
 MFENCE      | MOV [x],$2 | MOV EBX,[y] ;
 MOV EAX,[x] |            |             ;
exists
(x=2 /\ 0:EAX=0 /\ 2:EAX=2 /\ 2:EBX=0)
