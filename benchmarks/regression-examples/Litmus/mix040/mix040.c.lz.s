	.file	"/home/naling/src/examples/tso/regression-examples/mix040/mix040.c.lz.opt.bc"
	.file	1 "/home/naling/src/examples/tso/regression-examples/mix040/mix040.c"
...
.Ltmp1:
	.cfi_startproc
.Lfunc_begin0:
	.loc	1 33 0                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:33:0
# BB#0:                                 # %entry
	subl	$44, %esp
.Ltmp2:
	...
	.loc	1 35 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:35:3
.Ltmp3:
	movl	$1, b
	movl	$8, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 36 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:36:3
	movl	$1, x
	movl	$9, 20(%esp)
	movl	$32, 16(%esp)
	movl	$0, 12(%esp)
	...
	calll	clap_store_post
	movl	$1, %eax
	.loc	1 37 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:37:3
	addl	$44, %esp
	ret
.Ltmp4:
.Ltmp5:
...
.Ltmp8:
	.cfi_startproc
.Lfunc_begin1:
	.loc	1 41 0                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:41:0
# BB#0:                                 # %entry
	subl	$44, %esp
.Ltmp9:
	.cfi_def_cfa_offset 48
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 43 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:43:3
.Ltmp10:
	movl	$2, x
	movl	$18, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 44 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:44:3
	movl	$1, y
	movl	$19, 20(%esp)
	movl	$32, 16(%esp)
	movl	$0, 12(%esp)
	...
	calll	clap_store_post
	movl	$1, %eax
	.loc	1 45 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:45:3
	addl	$44, %esp
	ret
.Ltmp11:
.Ltmp12:
...
.Ltmp16:
	.cfi_startproc
.Lfunc_begin2:
	.loc	1 49 0                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:49:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp17:
...
.Ltmp19:
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 51 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:51:3
.Ltmp20:
	movl	$2, y
	movl	$28, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 52 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:52:3
	movl	z, %esi
	movl	$29, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	movl	%esi, 32(%esp)
	.loc	1 53 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:53:3
	movl	%esi, 4(%esp)
	movl	$.L.str, (%esp)
	calll	printf
	.loc	1 54 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:54:3
	cmpl	$0, 32(%esp)
	sete	%al
	movzbl	%al, %eax
	addl	$40, %esp
...
.Ltmp26:
	.cfi_startproc
.Lfunc_begin3:
	.loc	1 58 0                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:58:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp27:
	.cfi_def_cfa_offset 8
...
.Ltmp29:
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 60 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:60:3
.Ltmp30:
	movl	$1, z
	movl	$45, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 61 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:61:3
	movl	$1, a
	movl	$46, 20(%esp)
	movl	$32, 16(%esp)
	movl	$0, 12(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 62 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:62:3
	movl	a, %esi
	movl	$47, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 63 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:63:3
	movl	b, %esi
	movl	$49, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	calll	clap_load_post
	movl	%esi, 28(%esp)
	.loc	1 64 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:64:3
	movl	32(%esp), %eax
	movl	%esi, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$.L.str1, (%esp)
	calll	printf
	xorb	%al, %al
	.loc	1 65 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:65:3
	cmpl	$1, 32(%esp)
	jne	.LBB3_2
# BB#1:                                 # %land.rhs
	cmpl	$0, 28(%esp)
...
.LBB3_2:                                # %land.end
	movzbl	%al, %eax
	.loc	1 66 1                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:66:1
	addl	$40, %esp
	popl	%esi
	ret
.Ltmp32:
...
.Ltmp37:
	.cfi_startproc
.Lfunc_begin4:
	.loc	1 69 0                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:69:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp38:
	.cfi_def_cfa_offset 8
...
.Ltmp40:
	...
	movl	$0, 52(%esp)
	leal	48(%esp), %eax
	.loc	1 73 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:73:3
.Ltmp41:
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P0, 8(%esp)
	...
	leal	44(%esp), %eax
	.loc	1 74 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:74:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P1, 8(%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_create
	leal	40(%esp), %eax
	.loc	1 75 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:75:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P2, 8(%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_create
	leal	36(%esp), %eax
	.loc	1 76 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:76:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P3, 8(%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_create
	.loc	1 78 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:78:3
	movl	48(%esp), %eax
	leal	32(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 79 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:79:3
	movl	44(%esp), %eax
	leal	28(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 80 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:80:3
	movl	40(%esp), %eax
	leal	24(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 81 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:81:3
	movl	36(%esp), %eax
	leal	20(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 84 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:84:3
	movl	x, %esi
	movl	$98, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
...
# BB#3:                                 # %land.lhs.true10
	...
	je	.LBB4_5
# BB#4:                                 # %if.then
	.loc	1 85 5                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:85:5
.Ltmp42:
	movl	$.L.str2, (%esp)
	calll	printf
	.loc	1 86 5                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:86:5
	movl	$.L.str3, (%esp)
	calll	printf
.Ltmp43:
.LBB4_5:                                # %if.end
	xorl	%eax, %eax
	.loc	1 89 3                  # /home/naling/src/examples/tso/regression-examples/mix040/mix040.c:89:3
	addl	$56, %esp
	popl	%esi
	ret
.Ltmp44:
...
.Linfo_begin1:
	...
	.ascii	 "/home/naling/src/examples/tso/regression-examples/mix040/mix040.c" # DW_AT_name
	.byte	0
