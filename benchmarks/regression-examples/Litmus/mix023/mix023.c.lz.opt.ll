; ModuleID = '/home/naling/src/examples/tso/regression-examples/mix023/mix023.c.lz.opt.bc'
...
entry:
  ...
  ret i8* inttoptr (i32 1 to i8*), !dbg !102, !clap !103
}
...
entry:
  ...
  call void (i32, ...)* @clap_store_pre(i32 5, i32* @z, i32 2, i32 0, i32 32, i32 53)
  store i32 2, i32* @z, align 4, !dbg !118, !clap !119
  call void (i32, ...)* @clap_store_post(i32 5, i32* @z, i32 2, i32 0, i32 32, i32 53)
  ...
  %cmp = icmp eq i32 %tmp4, 2, !dbg !130, !clap !132
...
entry:
  ...
  %cmp = icmp eq i32 %tmp8, 2, !dbg !203, !clap !205
  br i1 %cmp, label %land.lhs.true, label %if.end, !dbg !203, !clap !206

land.lhs.true:                                    ; preds = %entry
  call void (i32, ...)* @clap_load_pre(i32 4, i32* @z, i32 0, i32 32, i32 108)
  %tmp9 = load i32* @z, align 4, !dbg !203, !clap !207
  call void (i32, ...)* @clap_load_post(i32 4, i32* @z, i32 0, i32 32, i32 108)
  %cmp8 = icmp eq i32 %tmp9, 2, !dbg !203, !clap !208
  br i1 %cmp8, label %land.lhs.true9, label %if.end, !dbg !203, !clap !209

land.lhs.true9:                                   ; preds = %land.lhs.true
  %tmp10 = load i32* %cond1, align 4, !dbg !203, !clap !210
  %tobool = icmp ne i32 %tmp10, 0, !dbg !203, !clap !211
  br i1 %tobool, label %land.lhs.true10, label %if.end, !dbg !203, !clap !212

land.lhs.true10:                                  ; preds = %land.lhs.true9
  %tmp11 = load i32* %cond3, align 4, !dbg !203, !clap !213
  %tobool11 = icmp ne i32 %tmp11, 0, !dbg !203, !clap !214
  br i1 %tobool11, label %if.then, label %if.end, !dbg !203, !clap !215

if.then:                                          ; preds = %land.lhs.true10
  %call12 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([37 x i8]* @.str2, i32 0, i32 0)), !dbg !216, !clap !218
  %call13 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([30 x i8]* @.str3, i32 0, i32 0)), !dbg !219, !clap !220
  br label %if.end, !dbg !221, !clap !222

if.end:                                           ; preds = %if.then, %land.lhs.true10, %land.lhs.true9, %land.lhs.true, %entry
  ret i32 0, !dbg !223, !clap !224
}
...
!0 = metadata !{i32 720913, i32 0, i32 12, metadata !"/home/naling/src/examples/tso/regression-examples/mix023/mix023.c", metadata !"/home/naling/src/inspect-0.3", metadata !"clang version 3.0 (tags/RELEASE_30/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !19} ; [ DW_TAG_compile_unit ]
...
!6 = metadata !{i32 720937, metadata !"/home/naling/src/examples/tso/regression-examples/mix023/mix023.c", metadata !"/home/naling/src/inspect-0.3", null} ; [ DW_TAG_file_type ]
...
!101 = metadata !{i32 44}
!102 = metadata !{i32 54, i32 3, metadata !92, null}
!103 = metadata !{i32 45}
!104 = metadata !{i32 46}
!105 = metadata !{i32 47}
!106 = metadata !{i32 48}
...
!211 = metadata !{i32 112}
!212 = metadata !{i32 113}
!213 = metadata !{i32 114}
!214 = metadata !{i32 115}
!215 = metadata !{i32 116}
!216 = metadata !{i32 84, i32 5, metadata !217, null}
!217 = metadata !{i32 720907, metadata !153, i32 83, i32 41, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!218 = metadata !{i32 117}
!219 = metadata !{i32 85, i32 5, metadata !217, null}
!220 = metadata !{i32 118}
!221 = metadata !{i32 86, i32 3, metadata !217, null}
!222 = metadata !{i32 119}
!223 = metadata !{i32 88, i32 3, metadata !153, null}
!224 = metadata !{i32 120}
