 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix023.litmus
 *

X86 mix023
"Fre PodWW Wse Rfi PodRR Fre PodWW Wse Rfi PodRR"
...
Safe=Fre Wse PodWW
{
 ...
 MOV [x],$1 | MOV EAX,[x] | MOV [z],$1 | MOV EAX,[z] ;
            | MOV EBX,[y] |            | MOV EBX,[a] ;
exists
(x=2 /\ z=2 /\ 1:EAX=2 /\ 1:EBX=0 /\ 3:EAX=2 /\ 3:EBX=0)
