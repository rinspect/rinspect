	.file	"/home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c.lz.opt.bc"
	.file	1 "/home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c"
...
.Ltmp1:
	.cfi_startproc
.Lfunc_begin0:
	.loc	1 30 0                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:30:0
# BB#0:                                 # %entry
	subl	$44, %esp
.Ltmp2:
	...
	.loc	1 32 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:32:3
.Ltmp3:
	movl	$1, x
	movl	$8, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 33 3                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:33:3
	movl	$1, y
	movl	$9, 20(%esp)
	movl	$32, 16(%esp)
	movl	$0, 12(%esp)
	...
	calll	clap_store_post
	xorl	%eax, %eax
	.loc	1 34 3                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:34:3
	addl	$44, %esp
	ret
.Ltmp4:
.Ltmp5:
...
.Ltmp9:
	.cfi_startproc
.Lfunc_begin1:
	.loc	1 38 0                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:38:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp10:
...
.Ltmp12:
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 40 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:40:3
.Ltmp13:
	movl	$2, y
	movl	$18, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 41 3                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:41:3
	movl	y, %esi
	movl	$19, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 42 3                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:42:3
	movl	x, %esi
	movl	$21, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	calll	clap_load_post
	movl	%esi, 28(%esp)
	.loc	1 43 3                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:43:3
	movl	32(%esp), %eax
	movl	%esi, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$.L.str, (%esp)
	calll	printf
	xorb	%al, %al
	.loc	1 44 3                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:44:3
	cmpl	$2, 32(%esp)
	jne	.LBB1_2
# BB#1:                                 # %land.rhs
	cmpl	$0, 28(%esp)
...
.LBB1_2:                                # %land.end
	movzbl	%al, %eax
	.loc	1 45 1                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:45:1
	addl	$40, %esp
	popl	%esi
	ret
.Ltmp15:
...
.Ltmp20:
	.cfi_startproc
.Lfunc_begin2:
	.loc	1 51 0                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:51:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp21:
	.cfi_def_cfa_offset 8
...
.Ltmp23:
	...
	movl	$0, 52(%esp)
	leal	48(%esp), %eax
	.loc	1 55 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:55:3
.Ltmp24:
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P0, 8(%esp)
	...
	leal	44(%esp), %eax
	.loc	1 56 3                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:56:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P1, 8(%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_create
	.loc	1 58 3                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:58:3
	movl	48(%esp), %eax
	movl	%eax, (%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_join
	.loc	1 59 3                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:59:3
	movl	44(%esp), %eax
	leal	28(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 61 3                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:61:3
	cmpl	$0, 28(%esp)
	je	.LBB2_3
# BB#1:                                 # %land.lhs.true
	movl	$64, 16(%esp)
	...
	jne	.LBB2_3
# BB#2:                                 # %if.then
	.loc	1 62 5                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:62:5
.Ltmp25:
	movl	$.L.str1, (%esp)
	calll	printf
	.loc	1 63 5                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:63:5
	movl	$.L.str2, (%esp)
	calll	printf
.Ltmp26:
.LBB2_3:                                # %if.end
	xorl	%eax, %eax
	.loc	1 66 3                  # /home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c:66:3
	addl	$56, %esp
	popl	%esi
	ret
.Ltmp27:
...
.Linfo_begin1:
	...
	.ascii	 "/home/naling/src/examples/tso/regression-examples/rfi007/rfi007.c" # DW_AT_name
	.byte	0
