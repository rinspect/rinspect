	.file	"../examples/tso/regression-examples/mix055/mix055.c.lz.opt.bc"
	.file	1 "/home/naling/src/inspect-0.3/../examples/tso/regression-examples/mix055/mix055.c"
...
.Ltmp1:
	.cfi_startproc
.Lfunc_begin0:
	.loc	1 31 0                  # ../examples/tso/regression-examples/mix055/mix055.c:31:0
# BB#0:                                 # %entry
	subl	$44, %esp
.Ltmp2:
	...
	.loc	1 33 3 prologue_end     # ../examples/tso/regression-examples/mix055/mix055.c:33:3
.Ltmp3:
	movl	$1, a
	movl	$8, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 34 3                  # ../examples/tso/regression-examples/mix055/mix055.c:34:3
	movl	$1, x
	movl	$9, 20(%esp)
	movl	$32, 16(%esp)
	movl	$0, 12(%esp)
	...
	calll	clap_store_post
	movl	$1, %eax
	.loc	1 35 3                  # ../examples/tso/regression-examples/mix055/mix055.c:35:3
	addl	$44, %esp
	ret
.Ltmp4:
.Ltmp5:
...
.Ltmp9:
	.cfi_startproc
.Lfunc_begin1:
	.loc	1 39 0                  # ../examples/tso/regression-examples/mix055/mix055.c:39:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp10:
...
.Ltmp12:
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 41 3 prologue_end     # ../examples/tso/regression-examples/mix055/mix055.c:41:3
.Ltmp13:
	movl	$2, x
	movl	$18, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 42 3                  # ../examples/tso/regression-examples/mix055/mix055.c:42:3
	movl	y, %esi
	movl	$19, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	movl	%esi, 32(%esp)
	.loc	1 43 3                  # ../examples/tso/regression-examples/mix055/mix055.c:43:3
	movl	%esi, 4(%esp)
	movl	$.L.str, (%esp)
	calll	printf
	.loc	1 44 3                  # ../examples/tso/regression-examples/mix055/mix055.c:44:3
	cmpl	$0, 32(%esp)
	sete	%al
	movzbl	%al, %eax
	addl	$40, %esp
...
.Ltmp18:
	.cfi_startproc
.Lfunc_begin2:
	.loc	1 48 0                  # ../examples/tso/regression-examples/mix055/mix055.c:48:0
# BB#0:                                 # %entry
	subl	$44, %esp
.Ltmp19:
	.cfi_def_cfa_offset 48
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 50 3 prologue_end     # ../examples/tso/regression-examples/mix055/mix055.c:50:3
.Ltmp20:
	movl	$1, y
	movl	$35, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 51 3                  # ../examples/tso/regression-examples/mix055/mix055.c:51:3
	movl	$1, z
	movl	$36, 20(%esp)
	movl	$32, 16(%esp)
	movl	$0, 12(%esp)
	...
	calll	clap_store_post
	movl	$1, %eax
	.loc	1 52 3                  # ../examples/tso/regression-examples/mix055/mix055.c:52:3
	addl	$44, %esp
	ret
.Ltmp21:
.Ltmp22:
...
.Ltmp26:
	.cfi_startproc
.Lfunc_begin3:
	.loc	1 56 0                  # ../examples/tso/regression-examples/mix055/mix055.c:56:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp27:
	.cfi_def_cfa_offset 8
...
.Ltmp29:
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 58 3 prologue_end     # ../examples/tso/regression-examples/mix055/mix055.c:58:3
.Ltmp30:
	movl	$2, z
	movl	$45, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 59 3                  # ../examples/tso/regression-examples/mix055/mix055.c:59:3
	movl	a, %esi
	movl	$46, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	calll	clap_load_post
	movl	%esi, 32(%esp)
	.loc	1 60 3                  # ../examples/tso/regression-examples/mix055/mix055.c:60:3
	movl	%esi, 4(%esp)
	movl	$.L.str1, (%esp)
	calll	printf
	.loc	1 61 3                  # ../examples/tso/regression-examples/mix055/mix055.c:61:3
	cmpl	$0, 32(%esp)
	sete	%al
	movzbl	%al, %eax
	addl	$40, %esp
...
.Ltmp36:
	.cfi_startproc
.Lfunc_begin4:
	.loc	1 65 0                  # ../examples/tso/regression-examples/mix055/mix055.c:65:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp37:
	.cfi_def_cfa_offset 8
...
.Ltmp39:
	...
	movl	$0, 52(%esp)
	leal	48(%esp), %eax
	.loc	1 69 3 prologue_end     # ../examples/tso/regression-examples/mix055/mix055.c:69:3
.Ltmp40:
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P0, 8(%esp)
	...
	leal	44(%esp), %eax
	.loc	1 70 3                  # ../examples/tso/regression-examples/mix055/mix055.c:70:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P1, 8(%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_create
	leal	40(%esp), %eax
	.loc	1 71 3                  # ../examples/tso/regression-examples/mix055/mix055.c:71:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P2, 8(%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_create
	leal	36(%esp), %eax
	.loc	1 72 3                  # ../examples/tso/regression-examples/mix055/mix055.c:72:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P3, 8(%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_create
	.loc	1 74 3                  # ../examples/tso/regression-examples/mix055/mix055.c:74:3
	movl	48(%esp), %eax
	leal	32(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 75 3                  # ../examples/tso/regression-examples/mix055/mix055.c:75:3
	movl	44(%esp), %eax
	leal	28(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 76 3                  # ../examples/tso/regression-examples/mix055/mix055.c:76:3
	movl	40(%esp), %eax
	leal	24(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 77 3                  # ../examples/tso/regression-examples/mix055/mix055.c:77:3
	movl	36(%esp), %eax
	leal	20(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 80 3                  # ../examples/tso/regression-examples/mix055/mix055.c:80:3
	movl	x, %esi
	movl	$89, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
...
# BB#3:                                 # %land.lhs.true10
	...
	je	.LBB4_5
# BB#4:                                 # %if.then
	.loc	1 81 5                  # ../examples/tso/regression-examples/mix055/mix055.c:81:5
.Ltmp41:
	movl	$.L.str2, (%esp)
	calll	printf
	.loc	1 82 5                  # ../examples/tso/regression-examples/mix055/mix055.c:82:5
	movl	$.L.str3, (%esp)
	calll	printf
.Ltmp42:
.LBB4_5:                                # %if.end
	xorl	%eax, %eax
	.loc	1 85 3                  # ../examples/tso/regression-examples/mix055/mix055.c:85:3
	addl	$56, %esp
	popl	%esi
	ret
.Ltmp43:
...
.Linfo_begin1:
	...
	.ascii	 "../examples/tso/regression-examples/mix055/mix055.c" # DW_AT_name
	.byte	0
