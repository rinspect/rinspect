 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix037.litmus
 *

X86 mix037
"Fre PodWW Wse PodWR Fre PodWR Fre PodWW Rfi PodRR"
Cycle=Rfi PodRR Fre PodWW Wse PodWR Fre PodWR Fre PodWW
Relax=[Rfi,PodRR] PodWR
Safe=Fre Wse PodWW
{
}
 P0         | P1          | P2          | P3          ;
 MOV [b],$1 | MOV [x],$2  | MOV [y],$1  | MOV [z],$1  ;
