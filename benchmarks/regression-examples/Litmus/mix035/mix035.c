 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix035.litmus
 *

X86 mix035
"Fre PodWR Fre PodWR Fre PodWW Rfi PodRR"
Cycle=Rfi PodRR Fre PodWR Fre PodWR Fre PodWW
Relax=[Rfi,PodRR] PodWR
Safe=Fre PodWW
{
}
 P0          | P1          | P2          ;
 MOV [a],$1  | MOV [x],$1  | MOV [y],$1  ;
 MOV EAX,[x] | MOV EAX,[y] | MOV [z],$1  ;
             |             | MOV EAX,[z] ;
             |             | MOV EBX,[a] ;
exists
(0:EAX=0 /\ 1:EAX=0 /\ 2:EAX=1 /\ 2:EBX=0)
