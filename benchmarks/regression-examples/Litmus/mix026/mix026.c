 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix026.litmus
 *

X86 mix026
"Fre PodWR Fre PodWR Fre PodWW Wse Rfi PodRR"
Cycle=Rfi PodRR Fre PodWR Fre PodWR Fre PodWW Wse
Relax=[Rfi,PodRR] PodWR
Safe=Fre Wse PodWW
{
}
 P0          | P1          | P2         | P3          ;
 MOV [a],$1  | MOV [x],$1  | MOV [y],$1 | MOV [z],$2  ;
 MOV EAX,[x] | MOV EAX,[y] | MOV [z],$1 | MOV EAX,[z] ;
             |             |            | MOV EBX,[a] ;
exists
(z=2 /\ 0:EAX=0 /\ 1:EAX=0 /\ 3:EAX=2 /\ 3:EBX=0)
