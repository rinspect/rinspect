	.file	"/home/naling/src/examples/tso/regression-examples/mix012/mix012.c.lz.opt.bc"
	.file	1 "/home/naling/src/examples/tso/regression-examples/mix012/mix012.c"
...
.Ltmp2:
	.cfi_startproc
.Lfunc_begin0:
	.loc	1 32 0                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:32:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp3:
...
.Ltmp5:
	...
	.loc	1 34 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:34:3
.Ltmp6:
	movl	$1, y
	movl	$8, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 35 3                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:35:3
	movl	x, %esi
	movl	$9, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	movl	%esi, 32(%esp)
	.loc	1 36 3                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:36:3
	movl	%esi, 4(%esp)
	movl	$.L.str, (%esp)
	calll	printf
	.loc	1 37 3                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:37:3
	cmpl	$0, 32(%esp)
	sete	%al
	movzbl	%al, %eax
	addl	$40, %esp
...
.Ltmp12:
	.cfi_startproc
.Lfunc_begin1:
	.loc	1 41 0                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:41:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp13:
	.cfi_def_cfa_offset 8
...
.Ltmp15:
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 43 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:43:3
.Ltmp16:
	movl	$1, x
	movl	$25, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 44 3                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:44:3
	movl	x, %esi
	movl	$26, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 45 3                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:45:3
	movl	y, %esi
	movl	$28, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	calll	clap_load_post
	movl	%esi, 28(%esp)
	.loc	1 46 3                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:46:3
	movl	32(%esp), %eax
	movl	%esi, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$.L.str1, (%esp)
	calll	printf
	xorb	%al, %al
	.loc	1 47 3                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:47:3
	cmpl	$1, 32(%esp)
	jne	.LBB1_2
# BB#1:                                 # %land.rhs
	cmpl	$0, 28(%esp)
...
.LBB1_2:                                # %land.end
	movzbl	%al, %eax
	.loc	1 48 1                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:48:1
	addl	$40, %esp
	popl	%esi
	ret
.Ltmp18:
...
.Ltmp22:
	.cfi_startproc
.Lfunc_begin2:
	.loc	1 51 0                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:51:0
# BB#0:                                 # %entry
	subl	$44, %esp
.Ltmp23:
	.cfi_def_cfa_offset 48
	movl	$0, 40(%esp)
	leal	36(%esp), %eax
	.loc	1 55 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:55:3
.Ltmp24:
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P0, 8(%esp)
	...
	leal	32(%esp), %eax
	.loc	1 56 3                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:56:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P1, 8(%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_create
	.loc	1 58 3                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:58:3
	movl	36(%esp), %eax
	leal	24(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 59 3                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:59:3
	movl	32(%esp), %eax
	leal	20(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 62 3                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:62:3
	cmpl	$0, 24(%esp)
	je	.LBB2_3
# BB#1:                                 # %land.lhs.true
	cmpl	$0, 20(%esp)
	je	.LBB2_3
# BB#2:                                 # %if.then
	.loc	1 63 5                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:63:5
.Ltmp25:
	movl	$.L.str2, (%esp)
	calll	printf
	.loc	1 64 5                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:64:5
	movl	$.L.str3, (%esp)
	calll	printf
.Ltmp26:
.LBB2_3:                                # %if.end
	xorl	%eax, %eax
	.loc	1 67 3                  # /home/naling/src/examples/tso/regression-examples/mix012/mix012.c:67:3
	addl	$44, %esp
	ret
.Ltmp27:
.Ltmp28:
...
.L.str2:
	.asciz	 "@@@CLAP: Tghere is a SC violation! \n"
	.size	.L.str2, 37
...
.Linfo_begin1:
	...
	.ascii	 "/home/naling/src/examples/tso/regression-examples/mix012/mix012.c" # DW_AT_name
	.byte	0
