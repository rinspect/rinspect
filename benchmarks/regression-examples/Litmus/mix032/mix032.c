 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix032.litmus
 *

X86 mix032
"Fre PodWR Fre PodWW Rfi PodRR Fre PodWW Rfi PodRR"
Cycle=Rfi PodRR Fre PodWW Rfi PodRR Fre PodWR Fre PodWW
Relax=[Rfi,PodRR] PodWR
Safe=Fre PodWW
{
}
 P0          | P1          | P2          ;
 MOV [b],$1  | MOV [x],$1  | MOV [z],$1  ;
 MOV EAX,[x] | MOV [y],$1  | MOV [a],$1  ;
             | MOV EAX,[y] | MOV EAX,[a] ;
             | MOV EBX,[z] | MOV EBX,[b] ;
exists
