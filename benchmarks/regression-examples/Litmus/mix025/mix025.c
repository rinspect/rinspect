 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix025.litmus
 *

X86 mix025
"Fre PodWR Fre PodWW Wse Rfi PodRR"
...
Safe=Fre Wse PodWW
{
 ...
 P0          | P1         | P2          ;
 MOV [z],$1  | MOV [x],$1 | MOV [y],$2  ;
 MOV EAX,[x] | MOV [y],$1 | MOV EAX,[y] ;
             |            | MOV EBX,[z] ;
exists
(y=2 /\ 0:EAX=0 /\ 2:EAX=2 /\ 2:EBX=0)
