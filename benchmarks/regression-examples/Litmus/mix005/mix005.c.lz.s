	.file	"../examples/tso/regression-examples/mix005/mix005.c.lz.opt.bc"
	.file	1 "/home/naling/src/inspect-0.3/../examples/tso/regression-examples/mix005/mix005.c"
...
.Ltmp1:
	.cfi_startproc
.Lfunc_begin0:
	.loc	1 32 0                  # ../examples/tso/regression-examples/mix005/mix005.c:32:0
# BB#0:                                 # %entry
	subl	$44, %esp
.Ltmp2:
	...
	.loc	1 34 3 prologue_end     # ../examples/tso/regression-examples/mix005/mix005.c:34:3
.Ltmp3:
	movl	$1, a
	movl	$8, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 35 3                  # ../examples/tso/regression-examples/mix005/mix005.c:35:3
	movl	$1, x
	movl	$9, 20(%esp)
	movl	$32, 16(%esp)
	movl	$0, 12(%esp)
	...
	calll	clap_store_post
	movl	$1, %eax
	.loc	1 36 3                  # ../examples/tso/regression-examples/mix005/mix005.c:36:3
	addl	$44, %esp
	ret
.Ltmp4:
.Ltmp5:
...
.Ltmp9:
	.cfi_startproc
.Lfunc_begin1:
	.loc	1 40 0                  # ../examples/tso/regression-examples/mix005/mix005.c:40:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp10:
...
.Ltmp12:
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 42 3 prologue_end     # ../examples/tso/regression-examples/mix005/mix005.c:42:3
.Ltmp13:
	movl	$2, x
	movl	$18, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 43 3                  # ../examples/tso/regression-examples/mix005/mix005.c:43:3
	movl	y, %esi
	movl	$19, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	movl	%esi, 32(%esp)
	.loc	1 44 3                  # ../examples/tso/regression-examples/mix005/mix005.c:44:3
	movl	%esi, 4(%esp)
	movl	$.L.str, (%esp)
	calll	printf
	.loc	1 45 3                  # ../examples/tso/regression-examples/mix005/mix005.c:45:3
	cmpl	$0, 32(%esp)
	sete	%al
	movzbl	%al, %eax
	addl	$40, %esp
...
.Ltmp19:
	.cfi_startproc
.Lfunc_begin2:
	.loc	1 49 0                  # ../examples/tso/regression-examples/mix005/mix005.c:49:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp20:
	.cfi_def_cfa_offset 8
...
.Ltmp22:
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 51 3 prologue_end     # ../examples/tso/regression-examples/mix005/mix005.c:51:3
.Ltmp23:
	movl	$1, y
	movl	$35, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 52 3                  # ../examples/tso/regression-examples/mix005/mix005.c:52:3
	movl	y, %esi
	movl	$36, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 53 3                  # ../examples/tso/regression-examples/mix005/mix005.c:53:3
	movl	z, %esi
	movl	$38, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	calll	clap_load_post
	movl	%esi, 28(%esp)
	.loc	1 54 3                  # ../examples/tso/regression-examples/mix005/mix005.c:54:3
	movl	32(%esp), %eax
	movl	%esi, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$.L.str1, (%esp)
	calll	printf
	xorb	%al, %al
	.loc	1 55 3                  # ../examples/tso/regression-examples/mix005/mix005.c:55:3
	cmpl	$1, 32(%esp)
	jne	.LBB2_2
# BB#1:                                 # %land.rhs
	cmpl	$0, 28(%esp)
...
.LBB2_2:                                # %land.end
	movzbl	%al, %eax
	.loc	1 56 1                  # ../examples/tso/regression-examples/mix005/mix005.c:56:1
	addl	$40, %esp
	popl	%esi
	ret
.Ltmp25:
...
.Ltmp30:
	.cfi_startproc
.Lfunc_begin3:
	.loc	1 59 0                  # ../examples/tso/regression-examples/mix005/mix005.c:59:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp31:
	.cfi_def_cfa_offset 8
...
.Ltmp33:
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 61 3 prologue_end     # ../examples/tso/regression-examples/mix005/mix005.c:61:3
.Ltmp34:
	movl	$1, z
	movl	$60, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 62 3                  # ../examples/tso/regression-examples/mix005/mix005.c:62:3
	movl	z, %esi
	movl	$61, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 63 3                  # ../examples/tso/regression-examples/mix005/mix005.c:63:3
	movl	a, %esi
	movl	$63, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
	...
	calll	clap_load_post
	movl	%esi, 28(%esp)
	.loc	1 64 3                  # ../examples/tso/regression-examples/mix005/mix005.c:64:3
	movl	32(%esp), %eax
	movl	%esi, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$.L.str2, (%esp)
	calll	printf
	xorb	%al, %al
	.loc	1 65 3                  # ../examples/tso/regression-examples/mix005/mix005.c:65:3
	cmpl	$1, 32(%esp)
	jne	.LBB3_2
# BB#1:                                 # %land.rhs
	cmpl	$0, 28(%esp)
...
.LBB3_2:                                # %land.end
	movzbl	%al, %eax
	.loc	1 66 1                  # ../examples/tso/regression-examples/mix005/mix005.c:66:1
	addl	$40, %esp
	popl	%esi
	ret
.Ltmp36:
...
.Ltmp41:
	.cfi_startproc
.Lfunc_begin4:
	.loc	1 69 0                  # ../examples/tso/regression-examples/mix005/mix005.c:69:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp42:
	.cfi_def_cfa_offset 8
...
.Ltmp44:
	...
	movl	$0, 52(%esp)
	leal	48(%esp), %eax
	.loc	1 73 3 prologue_end     # ../examples/tso/regression-examples/mix005/mix005.c:73:3
.Ltmp45:
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P0, 8(%esp)
	...
	leal	44(%esp), %eax
	.loc	1 74 3                  # ../examples/tso/regression-examples/mix005/mix005.c:74:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P1, 8(%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_create
	leal	40(%esp), %eax
	.loc	1 75 3                  # ../examples/tso/regression-examples/mix005/mix005.c:75:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P2, 8(%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_create
	leal	36(%esp), %eax
	.loc	1 76 3                  # ../examples/tso/regression-examples/mix005/mix005.c:76:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P3, 8(%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_create
	.loc	1 78 3                  # ../examples/tso/regression-examples/mix005/mix005.c:78:3
	movl	48(%esp), %eax
	leal	32(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 79 3                  # ../examples/tso/regression-examples/mix005/mix005.c:79:3
	movl	44(%esp), %eax
	leal	28(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 80 3                  # ../examples/tso/regression-examples/mix005/mix005.c:80:3
	movl	40(%esp), %eax
	leal	24(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 81 3                  # ../examples/tso/regression-examples/mix005/mix005.c:81:3
	movl	36(%esp), %eax
	leal	20(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 85 3                  # ../examples/tso/regression-examples/mix005/mix005.c:85:3
	movl	x, %esi
	movl	$112, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
...
# BB#3:                                 # %land.lhs.true10
	cmpl	$0, 20(%esp)
	je	.LBB4_6
# BB#4:                                 # %land.lhs.true12
	cmpl	$0, 32(%esp)
	je	.LBB4_6
# BB#5:                                 # %if.then
	.loc	1 86 5                  # ../examples/tso/regression-examples/mix005/mix005.c:86:5
.Ltmp46:
	movl	$.L.str3, (%esp)
	calll	printf
	.loc	1 87 5                  # ../examples/tso/regression-examples/mix005/mix005.c:87:5
	movl	$.L.str4, (%esp)
	calll	printf
.Ltmp47:
.LBB4_6:                                # %if.end
	xorl	%eax, %eax
	.loc	1 90 3                  # ../examples/tso/regression-examples/mix005/mix005.c:90:3
	addl	$56, %esp
	popl	%esi
	ret
.Ltmp48:
...
.Linfo_begin1:
	...
	.ascii	 "../examples/tso/regression-examples/mix005/mix005.c" # DW_AT_name
	.byte	0
