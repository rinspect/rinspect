; ModuleID = '../examples/tso/regression-examples/mix005/mix005.c.lz.opt.bc'
...
@.str2 = private unnamed_addr constant [32 x i8] c"\0A %%%% (EAX3=%d, EBX3=%d) %%%%\0A\00", align 1
...
entry:
  ...
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([32 x i8]* @.str1, i32 0, i32 0), i32 %tmp2, i32 %tmp3), !dbg !96, !clap !99
  %tmp4 = load i32* %EAX, align 4, !dbg !100, !clap !101
  %cmp = icmp eq i32 %tmp4, 1, !dbg !100, !clap !102
...
entry:
  ...
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([32 x i8]* @.str2, i32 0, i32 0), i32 %tmp2, i32 %tmp3), !dbg !134, !clap !137
...
land.lhs.true10:                                  ; preds = %land.lhs.true8
  ...
  br i1 %tobool11, label %land.lhs.true12, label %if.end, !dbg !211, !clap !223

land.lhs.true12:                                  ; preds = %land.lhs.true10
  %tmp12 = load i32* %cond0, align 4, !dbg !211, !clap !224
  %tobool13 = icmp ne i32 %tmp12, 0, !dbg !211, !clap !225
  br i1 %tobool13, label %if.then, label %if.end, !dbg !211, !clap !226

if.then:                                          ; preds = %land.lhs.true12
  %call14 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([37 x i8]* @.str3, i32 0, i32 0)), !dbg !227, !clap !229
  %call15 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([30 x i8]* @.str4, i32 0, i32 0)), !dbg !230, !clap !231
  br label %if.end, !dbg !232, !clap !233

if.end:                                           ; preds = %if.then, %land.lhs.true12, %land.lhs.true10, %land.lhs.true8, %land.lhs.true, %entry
...
!0 = metadata !{i32 720913, i32 0, i32 12, metadata !"../examples/tso/regression-examples/mix005/mix005.c", metadata !"/home/naling/src/inspect-0.3", metadata !"clang version 3.0 (tags/RELEASE_30/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !19} ; [ DW_TAG_compile_unit ]
...
!6 = metadata !{i32 720937, metadata !"../examples/tso/regression-examples/mix005/mix005.c", metadata !"/home/naling/src/inspect-0.3", null} ; [ DW_TAG_file_type ]
...
!211 = metadata !{i32 85, i32 3, metadata !161, null}
...
!224 = metadata !{i32 124}
!225 = metadata !{i32 125}
!226 = metadata !{i32 126}
!227 = metadata !{i32 86, i32 5, metadata !228, null}
!228 = metadata !{i32 720907, metadata !161, i32 85, i32 51, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!229 = metadata !{i32 127}
!230 = metadata !{i32 87, i32 5, metadata !228, null}
!231 = metadata !{i32 128}
!232 = metadata !{i32 88, i32 3, metadata !228, null}
!233 = metadata !{i32 129}
!234 = metadata !{i32 90, i32 3, metadata !161, null}
!235 = metadata !{i32 130}
