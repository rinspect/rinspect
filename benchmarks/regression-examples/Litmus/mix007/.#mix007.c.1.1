 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix007.litmus
 *

 X86 mix007
 "Fre PodWR Fre PodWW Wse Rfi PodRR Fre Rfi PodRR"
 ...
 MOV EAX,[x] | MOV [y],$1 | MOV EAX,[y] | MOV EAX,[z] ;
             |            | MOV EBX,[z] | MOV EBX,[a] ;
 exists
 (y=2 /\ 0:EAX=0 /\ 2:EAX=2 /\ 2:EBX=0 /\ 3:EAX=1 /\ 3:EBX=0)
