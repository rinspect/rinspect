 ...
 * http://www.cprover.org/wmm/esop13/x86_litmus//mix011.litmus
 *

X86 mix011
"Fre PodWW Wse PodWW Rfi PodRR Fre Rfi PodRR"
Cycle=Rfi PodRR Fre Rfi PodRR Fre PodWW Wse PodWW
Relax=[Rfi,PodRR]
Safe=Fre Wse PodWW
{
}
 P0         | P1          | P2          ;
 MOV [a],$1 | MOV [x],$2  | MOV [z],$1  ;
 MOV [x],$1 | MOV [y],$1  | MOV EAX,[z] ;
            | MOV EAX,[y] | MOV EBX,[a] ;
            | MOV EBX,[z] |             ;
exists
