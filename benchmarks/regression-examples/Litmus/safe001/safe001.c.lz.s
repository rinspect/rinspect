	.file	"/home/naling/src/examples/tso/regression-examples/safe001/safe001.c.lz.opt.bc"
	.file	1 "/home/naling/src/examples/tso/regression-examples/safe001/safe001.c"
...
.Ltmp2:
	.cfi_startproc
.Lfunc_begin0:
	.loc	1 31 0                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:31:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp3:
...
.Ltmp5:
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 33 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:33:3
.Ltmp6:
	movl	y, %esi
	movl	$8, 16(%esp)
	movl	$32, 12(%esp)
	...
	.loc	1 34 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:34:3
	movl	$1, x
	movl	$10, 20(%esp)
	movl	$32, 16(%esp)
	movl	$0, 12(%esp)
	...
	.loc	1 35 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:35:3
	movl	32(%esp), %eax
	movl	%eax, 4(%esp)
	movl	$.L.str, (%esp)
	calll	printf
	.loc	1 36 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:36:3
	cmpl	$2, 32(%esp)
	sete	%al
	movzbl	%al, %eax
	addl	$40, %esp
...
.Ltmp11:
	.cfi_startproc
.Lfunc_begin1:
	.loc	1 40 0                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:40:0
# BB#0:                                 # %entry
	subl	$44, %esp
.Ltmp12:
	.cfi_def_cfa_offset 48
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 42 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:42:3
.Ltmp13:
	movl	$2, x
	movl	$25, 20(%esp)
	movl	$32, 16(%esp)
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 43 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:43:3
	movl	$1, y
	movl	$26, 20(%esp)
	movl	$32, 16(%esp)
	movl	$0, 12(%esp)
	...
	calll	clap_store_post
	movl	$1, %eax
	.loc	1 44 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:44:3
	addl	$44, %esp
	ret
.Ltmp14:
.Ltmp15:
...
.Ltmp19:
	.cfi_startproc
.Lfunc_begin2:
	.loc	1 48 0                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:48:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp20:
	.cfi_def_cfa_offset 8
...
.Ltmp22:
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 50 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:50:3
.Ltmp23:
	movl	y, %esi
	movl	$35, 16(%esp)
	movl	$32, 12(%esp)
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 51 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:51:3
	movl	$2, y
	movl	$37, 20(%esp)
	movl	$32, 16(%esp)
	movl	$0, 12(%esp)
	...
	movl	$5, (%esp)
	calll	clap_store_post
	.loc	1 52 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:52:3
	movl	32(%esp), %eax
	movl	%eax, 4(%esp)
	movl	$.L.str1, (%esp)
	calll	printf
	.loc	1 53 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:53:3
	cmpl	$1, 32(%esp)
	sete	%al
	movzbl	%al, %eax
	addl	$40, %esp
...
.Ltmp29:
	.cfi_startproc
.Lfunc_begin3:
	.loc	1 57 0                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:57:0
# BB#0:                                 # %entry
	pushl	%esi
.Ltmp30:
	.cfi_def_cfa_offset 8
...
.Ltmp32:
	...
	movl	$5, (%esp)
	calll	clap_store_pre
	.loc	1 61 3 prologue_end     # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:61:3
.Ltmp33:
	movl	$0, y
	movl	$59, 20(%esp)
	movl	$32, 16(%esp)
	...
	calll	clap_store_post
	leal	48(%esp), %eax
	.loc	1 63 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:63:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P0, 8(%esp)
	movl	$0, 4(%esp)
	...
	leal	44(%esp), %eax
	.loc	1 64 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:64:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P1, 8(%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_create
	leal	40(%esp), %eax
	.loc	1 65 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:65:3
	movl	%eax, (%esp)
	movl	$0, 12(%esp)
	movl	$P2, 8(%esp)
	movl	$0, 4(%esp)
	calll	clap_thread_create
	.loc	1 67 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:67:3
	movl	48(%esp), %eax
	leal	36(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 68 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:68:3
	movl	44(%esp), %eax
	leal	32(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	calll	clap_thread_join
	.loc	1 69 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:69:3
	movl	40(%esp), %eax
	leal	28(%esp), %ecx
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	...
	movl	$4, (%esp)
	calll	clap_load_pre
	.loc	1 72 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:72:3
	movl	x, %esi
	movl	$73, 16(%esp)
	movl	$32, 12(%esp)
	movl	$0, 8(%esp)
...
# BB#3:                                 # %land.lhs.true8
	...
	je	.LBB3_5
# BB#4:                                 # %if.then
	.loc	1 73 5                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:73:5
.Ltmp34:
	movl	$.L.str2, (%esp)
	calll	printf
	.loc	1 74 5                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:74:5
	movl	$.L.str3, (%esp)
	calll	printf
.Ltmp35:
.LBB3_5:                                # %if.end
	xorl	%eax, %eax
	.loc	1 77 3                  # /home/naling/src/examples/tso/regression-examples/safe001/safe001.c:77:3
	addl	$56, %esp
	popl	%esi
	ret
.Ltmp36:
...
.Linfo_begin1:
	...
	.ascii	 "/home/naling/src/examples/tso/regression-examples/safe001/safe001.c" # DW_AT_name
	.byte	0
