; ModuleID = '/home/naling/src/examples/tso/regression-examples/mix004/mix004.c.lz.opt.bc'
...
@.str3 = private unnamed_addr constant [32 x i8] c"\0A %%%% (EAX3=%d, EBX3=%d) %%%%\0A\00", align 1
...
entry:
  ...
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str, i32 0, i32 0), i32 %tmp1), !dbg !45, !clap !47
...
entry:
  ...
  %tmp = load i32* @y, align 4, !dbg !70, !clap !71
  call void (i32, ...)* @clap_load_post(i32 4, i32* @y, i32 0, i32 32, i32 26)
  store i32 %tmp, i32* %EAX, align 4, !dbg !70, !clap !72
  %tmp1 = load i32* %EAX, align 4, !dbg !73, !clap !74
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str1, i32 0, i32 0), i32 %tmp1), !dbg !73, !clap !75
  %tmp2 = load i32* %EAX, align 4, !dbg !76, !clap !77
  %cmp = icmp eq i32 %tmp2, 0, !dbg !76, !clap !78
  %conv = zext i1 %cmp to i32, !dbg !76, !clap !79
  %tmp3 = inttoptr i32 %conv to i8*, !dbg !76, !clap !80
  ret i8* %tmp3, !dbg !76, !clap !81
}
...
entry:
  ...
  call void (i32, ...)* @clap_store_pre(i32 5, i32* @y, i32 1, i32 0, i32 32, i32 42)
  store i32 1, i32* @y, align 4, !dbg !96, !clap !97
  call void (i32, ...)* @clap_store_post(i32 5, i32* @y, i32 1, i32 0, i32 32, i32 42)
  call void (i32, ...)* @clap_load_pre(i32 4, i32* @y, i32 0, i32 32, i32 43)
  %tmp = load i32* @y, align 4, !dbg !98, !clap !99
  call void (i32, ...)* @clap_load_post(i32 4, i32* @y, i32 0, i32 32, i32 43)
  ...
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([32 x i8]* @.str2, i32 0, i32 0), i32 %tmp2, i32 %tmp3), !dbg !104, !clap !107
...
entry:
  ...
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([32 x i8]* @.str3, i32 0, i32 0), i32 %tmp2, i32 %tmp3), !dbg !142, !clap !145
...
!0 = metadata !{i32 720913, i32 0, i32 12, metadata !"/home/naling/src/examples/tso/regression-examples/mix004/mix004.c", metadata !"/home/naling/src/inspect-0.3", metadata !"clang version 3.0 (tags/RELEASE_30/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !19} ; [ DW_TAG_compile_unit ]
...
!6 = metadata !{i32 720937, metadata !"/home/naling/src/examples/tso/regression-examples/mix004/mix004.c", metadata !"/home/naling/src/inspect-0.3", null} ; [ DW_TAG_file_type ]
...
!88 = metadata !{i32 39}
!89 = metadata !{i32 721152, metadata !90, metadata !"EAX", metadata !6, i32 51, metadata !22, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!92 = metadata !{i32 40}
!93 = metadata !{i32 721152, metadata !90, metadata !"EBX", metadata !6, i32 51, metadata !22, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!233 = metadata !{i32 720907, metadata !169, i32 85, i32 42, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
